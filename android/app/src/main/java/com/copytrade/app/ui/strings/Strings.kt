...
object Strings {
    ...
    val futuresTodayPnl = Bi("Today's futures PnL", "PnL ngayong araw sa Futures")
    ...
    val archive = Bi("Archive", "I-archive")
    val unarchive = Bi("Unarchive", "I-unarchive")
    val archivedTab = Bi("Archived", "Naka-archive")
    val pendingSignalsTab = Bi("Pending", "Pending")
    val noArchivedSignals = Bi("No archived signals", "Walang naka-archive na signal")
